...
data class AlbumDynamicInfo(
    val commentCount: Int,
    val shareCount: Int,
    val subscribedCount: Int
)

class DefaultAlbumDetailRepository(
...
interface AlbumDetailRemoteDataSource {
    suspend fun fetchAlbumContent(
        albumId: String,
        offset: Int,
        limit: Int
...
class NeteaseAlbumDetailRemoteDataSource(
...
const val DEFAULT_ALBUM_TRACK_PAGE_SIZE = 30
