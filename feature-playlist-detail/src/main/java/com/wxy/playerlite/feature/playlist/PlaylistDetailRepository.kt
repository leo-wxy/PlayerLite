...
data class PlaylistHeaderContent(
...
data class PlaylistDynamicInfo(
    val commentCount: Int,
    val isSubscribed: Boolean,
    val playCount: Long
)

class DefaultPlaylistDetailRepository(
...
interface PlaylistDetailRemoteDataSource {
...
class NeteasePlaylistDetailRemoteDataSource(
...
object PlaylistDetailJsonMapper {
...
const val DEFAULT_DETAIL_TRACK_PAGE_SIZE = 30
