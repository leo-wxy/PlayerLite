...
data class SideControlMotionSpec(
...
fun PlaybackMode.modeIcon(): ImageVector {
    return when (this) {
...
fun PlaybackMode.modePalette(): SideControlPalette {
    return when (this) {
...
fun PlaybackMode.modeMotionSpec(): SideControlMotionSpec {
    return when (this) {
